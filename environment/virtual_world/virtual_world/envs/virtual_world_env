...
class VirtualWorldEnv(gym.Env):
    ...
    def step(self, action):
        ...
        observation = [distance_to_objective, rotation_respect_to_objective, self.agent_bounding]
    ...
    def reset(self):
        ...
        return [distance_to_objective, rotation_respect_to_objective, self.agent_bounding]
    ...
    * @return La nueva rotacíon del agente.
    ...
    @staticmethod
    def calculate_rotation_respect_to_objective(self, distance, agent_pos, world_objective, agent_rot):
